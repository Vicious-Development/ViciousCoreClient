package com.vicious.viciouscoreclient.client.render.entity.living;
...
import com.vicious.viciouscoreclient.client.render.animation.Animation;
...
public class RenderGenericHumanoidEntity<T extends EntityLiving> extends RenderEntityLiving<T> {
    ...
    protected static CCModel defaultHeadModel = ViciousClientLoader.loadViciousModel("entity/obj/head.obj").backfacedCopy();
    protected static CCModel defaultLimbModel = ViciousClientLoader.loadViciousModel("entity/obj/limb.obj").backfacedCopy();
    protected static CCModel defaultBodyModel = ViciousClientLoader.loadViciousModel("entity/obj/body.obj").backfacedCopy();
