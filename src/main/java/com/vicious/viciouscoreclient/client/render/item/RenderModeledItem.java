...
import com.vicious.viciouscoreclient.client.configuration.ClientOverrideConfigurations;
...
import com.vicious.viciouscoreclient.client.render.ICCModelConsumer;
import com.vicious.viciouscoreclient.client.render.ICCModelUser;
import com.vicious.viciouscoreclient.client.render.animation.CCModelFrameRunner;
...
public abstract class RenderModeledItem implements ICCModelUser, ICCModelConsumer, IItemRenderer {
    ...
    public void renderItem(ItemStack item, ItemCameraTransforms.TransformType transformType) {
        ...
        getAnimation().runModelFrameAndRender(mdl,0,rs,mat);
    ...
    public ResourceLocation getModelTexture() {
        return ResourceCache.ORBSPRITELOCATION;
    }
}
