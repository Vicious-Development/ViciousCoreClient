package com.vicious.viciouscoreclient.client.render.entity.model.singlemob.passive;
...
public class OverrideModelCow extends ModelCow implements IOverrideModel {
    public Queue<Runnable> transforms = new LinkedList<>();
    private Map<String, Field> partMap = new HashMap<>();

    public OverrideModelCow(ModelCow og) {
        clone(og,partMap);
    }
