package com.vicious.viciouscoreclient.client.render.projectile;
...
public class RenderOrbProjectile<T extends OrbProjectile> extends RenderModeledProjectile<T>{
    ...
    public static CCModel defaultmodel = ViciousClientLoader.loadViciousModel("projectile/obj/orb.obj").backfacedCopy();
