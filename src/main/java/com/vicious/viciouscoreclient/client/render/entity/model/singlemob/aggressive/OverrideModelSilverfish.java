package com.vicious.viciouscoreclient.client.render.entity.model.singlemob.aggressive;
...
public class OverrideModelSilverfish extends ModelSilverfish implements IOverrideModel {
    public Queue<Runnable> transforms = new LinkedList<>();
    private Map<String, Field> partMap = new HashMap<>();

    public OverrideModelSilverfish(ModelSilverfish og) {
        clone(og,partMap);
    }
